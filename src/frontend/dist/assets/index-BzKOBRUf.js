...
const projects = [
  {
    ...
    description: "Built a fully functional e-commerce platform with product listings, cart management, payment integration, and admin dashboard. Features real-time inventory updates and responsive design.",
  ...
  },
  {
    ...
    description: "Developed a comprehensive HR management system with attendance tracking, leave management, payroll calculation, and role-based access control for 500+ employees.",
  ...
  },
  {
    ...
    description: "An AICTE-funded intelligent study planner that generates personalized learning paths using NLP. Integrates quiz generation, progress tracking, and spaced repetition algorithms.",
  ...
  },
  {
    ...
    description: "A sleek personal finance dashboard with expense categorization, budget goals, visual analytics charts, and monthly report generation with PDF export.",
  ...
  },
  {
    ...
    description: "A WhatsApp-inspired chat app with real-time messaging, group chats, media sharing, message reactions, and end-to-end encryption for private conversations.",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card/95 backdrop-blur-md shadow-soft border-b border-border/50" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-soft", children: "Akshaya" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Main navigation", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-1", children: navItems.map((item) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: `px-4 py-2 rounded-lg text-sm font-medium font-body transition-smooth inline-block ${isActive ? "bg-primary/10 text-primary" : "text-foreground/70 hover:text-foreground hover:bg-muted/60"}`,
                children: item.label
              }
            ) }, item.href);
          }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-5 h-0.5 bg-current mb-1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-5 h-0.5 bg-current mb-1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-5 h-0.5 bg-current" })
              ]
            }
          )
        ] }),
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/95 backdrop-blur-md border-b border-border/50 px-6 py-4 flex flex-col gap-2", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: item.href,
            onClick: (e) => handleNavClick(e, item.href),
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/40 py-6 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body text-muted-foreground/70", children: [
        "© ",
        year,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground/50", children: "Designed with 💜 in a pastel palette" })
    ] }) })
  ] });
}
/**
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "section-padding bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-mono font-semibold text-primary uppercase tracking-widest mb-3 px-3 py-1 rounded-full bg-primary/10", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Hello, I'm ",
        personalInfo.name,
        " 👋"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 mb-8", children: personalInfo.bio.map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground mb-3", children: "Tech Stack" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-chip", children: skill }, skill)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground mb-3", children: "Find me on" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: platformLinks.map(({ href, icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href,
            target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:pt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-pastel p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-lg text-foreground mb-6 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-7 h-7 rounded-lg bg-primary/15 flex items-center justify-center text-sm", children: "📋" }),
          "Personal Details"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 16, className: "text-primary mt-0.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-xs font-mono text-muted-foreground uppercase tracking-wide mb-0.5", children: "Email" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, className: "text-primary mt-0.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-xs font-mono text-muted-foreground uppercase tracking-wide mb-0.5", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-sm font-body text-foreground/80", children: personalInfo.phone })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, className: "text-primary mt-0.5 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-xs font-mono text-muted-foreground uppercase tracking-wide mb-0.5", children: "Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-sm font-body text-foreground/80", children: personalInfo.location })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/40 pt-5 flex flex-col gap-3", children: [
            {
              label: "GitHub",
          ...
          ].map(({ label, href, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href,
              target: "_blank",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 text-sm font-body text-foreground/70", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2 px-4 py-3 rounded-xl bg-chart-2/20 border border-chart-2/30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-chart-2 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body text-foreground/70", children: "Open to internships & opportunities" })
      ] })
    ] })
  ] }) }) });
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: cert.icon }),
          cert.credentialUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground leading-snug line-clamp-2", children: cert.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-foreground/60 mt-1 leading-snug", children: cert.issuer })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto pt-2 border-t border-foreground/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-foreground/50", children: cert.date }),
          cert.credentialUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: cert.credentialUrl,
...
function CertificationsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "certifications", className: "section-padding bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-mono font-semibold text-primary uppercase tracking-widest mb-3 px-3 py-1 rounded-full bg-primary/10", children: "Achievements" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Certifications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading max-w-md mx-auto", children: "Continuous learning through recognized online platforms and institutions" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4", children: certifications.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "animate-fade-in-up",
        style: { animationDelay: `${i * 0.07}s`, opacity: 0 },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CertCard, { cert })
      },
      cert.id
    )) })
  ] }) });
...
${message}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "section-padding bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-mono font-semibold text-primary uppercase tracking-widest mb-3 px-3 py-1 rounded-full bg-primary/10", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Contact Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading max-w-md mx-auto", children: "Have an opportunity or just want to say hello? I'd love to hear from you!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-pastel p-8", children: [
        ...
        sent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-10 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 40, className: "text-chart-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-lg", children: "Message composed!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "Your email client is opening. Click send there to complete delivery." })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground mb-1", children: "Let's connect" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground mb-6", children: "Find me on these platforms or reach out directly via email." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `mailto:${personalInfo.email}`,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground uppercase tracking-wide", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium text-foreground group-hover:text-primary transition-smooth", children: personalInfo.email })
                ] })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: socialLinks.map(({ href, icon: Icon2, label, username }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href,
            target: "_blank",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, className: "text-foreground/70" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium text-foreground group-hover:text-primary transition-smooth", children: label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground truncate", children: username })
              ] })
            ]
          },
          label
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-5xl sm:text-6xl md:text-7xl tracking-tight leading-tight mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-hero", children: personalInfo.name }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl font-body font-medium text-foreground/70 tracking-widest uppercase", children: personalInfo.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-base font-body text-muted-foreground", children: personalInfo.tagline })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 animate-float", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-10 rounded-full border-2 border-primary/30 flex items-start justify-center pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-2 bg-primary/50 rounded-full animate-bounce" }) }) })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground leading-snug group-hover:text-primary transition-smooth", children: project.title }),
        ...
        project.company && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs font-body text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 12 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.company }),
          project.duration && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 11 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.duration })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-foreground/65 leading-relaxed line-clamp-3", children: project.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-auto pt-2 border-t border-border/40", children: project.tech.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            variant: "secondary",
...
function ProjectsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "section-padding bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-mono font-semibold text-primary uppercase tracking-widest mb-3 px-3 py-1 rounded-full bg-primary/10", children: "Portfolio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Projects" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading max-w-md mx-auto", children: "From internship deliverables to personal side projects" })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 16, className: "text-foreground/70" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl text-foreground", children: "Internship Projects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground bg-muted/60 px-2.5 py-1 rounded-full", children: internshipProjects.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-5", children: internshipProjects.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "animate-fade-in-up",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl text-foreground", children: "Mini Projects" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground bg-muted/60 px-2.5 py-1 rounded-full", children: miniProjects.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: miniProjects.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "animate-fade-in-up",
          style: { animationDelay: `${i * 0.1}s`, opacity: 0 },
